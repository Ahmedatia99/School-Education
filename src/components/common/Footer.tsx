...
const Footer: React.FC = () => {
  return (
    <div className="container px-3 mx-auto">
      <footer
        className="bg-white font-semibold border-2 border-dark rounded-xs shadow-[6px_6px_0_var(--color-dark)] p-6 md:p-10 lg:p-14 flex flex-col gap-7 mt-25 mb-15"
        role="contentinfo"
      ...
      >
        ...
        <div className="flex flex-col md:flex-row items-start justify-between gap-10">
          ...
          >
            ...
            />
            <p
              className="mt-4 font-medium leading-relaxed text-center md:text-left"
              style={{ color: "#4C4C4D" }}
            >
            ...
            <address className="not-italic mt-6 space-y-4 font-medium">
              ...
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 p-2 border-2 border-dark rounded-sm bg-light flex items-center justify-center">
        ...
        {/* Bottom bar */}
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6 border-t-2 border-b-2 border-dark py-4">
        ...
        <div className="container mx-auto px-4">
          <div className="-mx-4 flex flex-wrap justify-between font-semibold">
